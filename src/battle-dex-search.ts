...
class BattleMoveSearch extends BattleTypedSearch<'move'> {
	...
	static readonly GOOD_STATUS_MOVES = [
		'acidarmor', 'agility', 'aromatherapy', 'auroraveil', 'autotomize', 'banefulbunker', 'barrelroll', 'batonpass', 'bellydrum', 'bulkup', 'cakelie', 'calmmind', 'clangoroussoul', 'coil', 'cottonguard', 'courtchange', 'curse', 'defog', 'destinybond', 'detect', 'disable', 'dragondance', 'drainingkiss', 'dreaminduction', 'electricalshield', 'encore', 'extremeevoboost', 'firewall', 'geomancy', 'glare', 'glitchyterrain', 'hardreset', 'haze', 'healbell', 'healingwish', 'healorder', 'heartswap', 'honeclaws', 'houraielixir', 'kingsshield', 'leechseed', 'lightscreen', 'lovelykiss', 'lunardance', 'magiccoat', 'maxguard', 'memento', 'milkdrink', 'moonlight', 'morningsun', 'mysterioussong', 'nastyplot', 'naturesmadness', 'noretreat', 'obstruct', 'painsplit', 'partingshot', 'patriotselixir', 'perishsong', 'protect', 'quiverdance', 'reboot', 'recollection', 'recover', 'reflect', 'reflecttype', 'releaseoftheid', 'rest', 'roar', 'rockpolish', 'roost', 'shellsmash', 'shiftgear', 'shoreup', 'slackoff', 'sleeppowder', 'sleeptalk', 'softboiled', 'softreset', 'spikes', 'spikyshield', 'spore', 'stealthrock', 'stickyweb', 'strengthenjutsu', 'strengthsap', 'study', 'substitute', 'switcheroo', 'swordsdance', 'synthesis', 'tailglow', 'tailwind', 'taunt', 'thunderwave', 'toxic', 'toxicspikes', 'transform', 'trick', 'umadbro', 'whirlwind', 'willowisp', 'wish', 'yawn', 'pixiedust',
	] as ID[] as readonly ID[];
	// Fundex: add custom good weak moves
	static readonly GOOD_WEAK_MOVES = [
		'accelerock', 'acidbomb', 'acrobatics', 'aquajet', 'avalanche', 'bonemerang', 'bouncybubble', 'bulletpunch', 'bulletspray', 'bullseye', 'buzzybuzz', 'circlethrow', 'clearsmog', 'doubleironbash', 'dragondarts', 'dragontail', 'endeavor', 'evilsealingcircle', 'facade', 'fantasyseal', 'firefang', 'flightofidaten', 'flipturn', 'freezedry', 'frustration', 'geargrind', 'grassknot', 'gyroball', 'hex', 'holdit', 'icefang', 'iceshard', 'iciclespear', 'knockoff', 'koin3steps', 'lemmingsparade', 'lightarrow', 'lolwut', 'lowkick', 'machpunch', 'mysteriouspower', 'narrowconfines', 'nightshade', 'nuzzle', 'nyan', 'objection', 'paralyzer', 'pikapapow', 'pingas', 'psychocut', 'pursuit', 'quickattack', 'rapidspin', 'return', 'rockblast', 'scorchingsands', 'seismictoss', 'shadowclaw', 'shadowsneak', 'sizzlyslide', 'sovietreversal', 'storedpower', 'stormthrow', 'suckerpunch', 'superfang', 'superglitch', 'superjump', 'surgingstrikes', 'surprise', 'tailslap', 'tripleaxel', 'umadbro', 'uturn', 'veeveevolley', 'voltswitch', 'watershuriken', 'weatherball', 'whirlingfortress', 'zerolaser', 'zzzap',
	] as ID[] as readonly ID[];
