...
class BattlePokemonSearch extends BattleTypedSearch<'pokemon'> {
	...
	getBaseResults(): SearchRow[] {
		...
		else if (format === 'fundex') tierSet = tierSet.slice(slices.Fundex);
		else if (format === 'nationalfundex') tierSet = tierSet.slice(slices.Fundex).concat(tierSet.slice(slices.OU));
		else if (format === 'fundexpurehackmons') tierSet = tierSet.slice(slices.Fundex).concat(tierSet.slice(slices.AG));
