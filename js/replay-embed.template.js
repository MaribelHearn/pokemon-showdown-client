...
linkStyle('https://ps.maribelhearn.com/style/font-awesome.css?');
linkStyle('https://ps.maribelhearn.com/style/battle.css?a7');
linkStyle('https://ps.maribelhearn.com/style/replay.css?a7');
linkStyle('https://ps.maribelhearn.com/style/utilichart.css?a7');

requireScript('https://ps.maribelhearn.com/js/lib/ps-polyfill.js');
requireScript('https://ps.maribelhearn.com/config/config.js?a7');
requireScript('https://ps.maribelhearn.com/js/lib/jquery-1.11.0.min.js');
requireScript('https://ps.maribelhearn.com/js/lib/html-sanitizer-minified.js');
requireScript('https://ps.maribelhearn.com/js/battle-sound.js');
requireScript('https://ps.maribelhearn.com/js/battledata.js?a7');
requireScript('https://ps.maribelhearn.com/data/pokedex-mini.js?a7');
requireScript('https://ps.maribelhearn.com/data/pokedex-mini-bw.js?a7');
requireScript('https://ps.maribelhearn.com/data/graphics.js?a7');
requireScript('https://ps.maribelhearn.com/data/pokedex.js?a7');
requireScript('https://ps.maribelhearn.com/data/moves.js?a7');
requireScript('https://ps.maribelhearn.com/data/abilities.js?a7');
requireScript('https://ps.maribelhearn.com/data/items.js?a7');
requireScript('https://ps.maribelhearn.com/data/teambuilder-tables.js?a7');
requireScript('https://ps.maribelhearn.com/js/battle-tooltips.js?a7');
requireScript('https://ps.maribelhearn.com/js/battle.js?a7');
